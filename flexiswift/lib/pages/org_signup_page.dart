...
import '../pages/org_signup_success_page.dart';
...
class _OrgSignUpPageState extends State<OrgSignUpPage> {
  ...
  Color orgPrefixColor = Colors.grey;
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          ...
          if (_formKey.currentState!.validate()) {
            final organization = orgController.text;
            ...
            try {
              var response = await apiService.post(
                'https://senad-cavkusic.sarajevoweb.com/api/signup/organization/',
                data: {
              ...
              if (response.statusCode == 201) {
                print('Response headers: ${response.headers}');
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => OrgSignUpSuccessPage()),
                  );
              }
            } catch (e) {
              if (e is DioError) {
